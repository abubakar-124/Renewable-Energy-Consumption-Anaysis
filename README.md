...
* Study sector-wise energy consumption
* Build forecasting models to predict future consumption
...
* Correlation heatmap between energy types
* Energy share distribution using pie and bar charts
...
* **Random Forest Regressor** – best performance model
...
* Industrial and Transportation sectors consume more energy
* Random Forest and ARIMA provide the most accurate predictions
...
**Abubakar Zafar**
Computer Science Graduate | Data Science Enthusiast
